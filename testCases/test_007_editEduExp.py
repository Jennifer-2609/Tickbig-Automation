...
class Test_007_EditEduExp:
    ...
    def test_editEduExpNegative(self,setup):
        ...
        # toast_msgH = self.driver.find_elements(By.XPATH, "/html/body/div[3]/div[3]/main/section/div[3]/div/div/div[1]/div/div/form/div[2]/div/div[5]/div")
        # resultH = toast_msgH[0].text
        # print(resultH)
        #
        # if resultH == "Start month & year is required.":
        #      assert True
        #      self.logger.info("********** Start month & year Negative Test passed *********")
        # else:
        #     assert False
        #     self.logger.info("********** Start month & year Negative Test failed *********")
        ...
        toast_msgL = self.driver.find_elements(By.XPATH,"/html/body/div[3]/div[3]/main/section/div[3]/div/div/div[2]/div/div/form/div[2]/div/div[4]/div")
        resultL = toast_msgL[0].text
        print(resultL)

        if resultL == "Start Year is required":
            assert True
        ...
        toast_msgM = self.driver.find_elements(By.XPATH,"/html/body/div[3]/div[3]/main/section/div[3]/div/div/div[2]/div/div/form/div[2]/div/div[5]/div")
        resultM = toast_msgM[0].text
        print(resultM)

        if resultM == "End Year is required":
            assert True
            self.logger.info("********** End Year Negative Test passed *********")
        else:
            assert False
            self.logger.info("********** End Year Negative Test failed *********")
        ...
        toast_msgP = self.driver.find_elements(By.XPATH,"/html/body/div[3]/div[3]/main/section/div[3]/div/div/div[2]/div/div/form/div[2]/div/div[5]/div")
        resultP = toast_msgP[0].text
        print(resultP)

        if resultP == "Invalid Year.":
            assert True
            self.logger.info("********** End Year Invalid Year Negative Test passed *********")
        else:
            assert False
            self.logger.info("********** End Year Invalid Year Negative Test failed *********")
