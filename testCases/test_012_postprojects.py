...
class Test_012_Projects:
    ...
    #
    #     error_msg7 = self.driver.find_elements(By.XPATH, "/html/body/div[1]/div[2]/section[1]/main/div/div/section/div/div[2]/div/form/div/div[2]/div[5]/div[2]/div/p")
    ...
    #
    #     error_msg8 = self.driver.find_elements(By.XPATH, "/html/body/div[1]/div[2]/section[1]/main/div/div/section/div/div[2]/div/form/div/div[2]/div[8]/p")
    ...
    #     self.pjt.scrollPostPjt()
    #     time.sleep(2)
    #     self.pjt.setwhocanapply1()   #click manually
    #     time.sleep(10)
    #     self.pjt.clickPostPjtFinalButton()
    #     time.sleep(2)
    #
    ...
    def test_staffnegative1(self, setup):
        ...
        error_msg7 = self.driver.find_elements(By.XPATH, "/html/body/div[1]/div[2]/section[1]/main/div/div/section/div/div[2]/div/form/div/div[2]/div[8]/div[2]/div/p")
        result = error_msg7[0].text
        if result == "Responsibility is required.":
            self.logger.info("Error Message Is: %s", result)
            assert True
    ...
    #     self.pjt.scrollPostPjt1()
    #     time.sleep(2)
    #     self.pjt.setwhocanapply2()  # click manually
    #     time.sleep(10)
    #     self.pjt.clickPostPjtFinalButton1()
    #     time.sleep(2)
    #
