...
class Test_013_ApplyProjects:
    ...
    #         self.logger.info("Error Message Is: %s", result)
    #         assert True
    #         self.logger.info("*************** Description should be more than 160 characters long Test Passed *************")
    #     else:
    #         assert False
    #         self.logger.info("*************** Description should be more than 160 characters long Test Failed *************")
    #
    #
    #     time.sleep(2)
