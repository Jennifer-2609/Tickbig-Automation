...
class Test_014_Fundraise:
    ...
    # Post fundraise - Positive Testcase
    # @pytest.mark.sanity
    def test_postfundpositive(self, setup):
        ...
        time.sleep(3)
        self.fund.selectWhocanapplyAccount1()
        time.sleep(2)
        self.fund.selectWhocanapplyAccount1()
        time.sleep(2)
        self.fund.selectWhocanapplyAccount1()
        ...
        result = error_msg2[0].text
        if result == "Fundraise posted successfully":
            self.logger.info("Error Message Is: %s", result)
        else:
            assert False
            self.logger.info("*************** Fundraise posted successfully Test Failed *************")
